...
class White_NoiseTests: XCTestCase {
    ...
    class ViewControllerMock: ViewController {
        ...
        var getTimeCalled: Bool = false
        var addTimerCalled: Bool = false
        ...
        override func setColor(color _: MainPresenter.NoiseColors) {
    ...
    func isVolumeEqual(volume1: Float, volume2: Float) -> Bool {
        volume2 < volume1 + 0.00001 && volume2 > volume1 - 0.00001
    }
